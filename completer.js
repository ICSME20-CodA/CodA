...
fetch("http://62.234.94.93:8080/NLI")
    ...
    editor.setValue("\nclass Main{\n    public void main(String[] args){\n        //start CodA by ctrl+x/command+x\n        \n    }\n}")
    ...
    var HoleCompleter = function (imports,code,fillers,contextVariables,info,types,beginCursor,i) {
        this.getCompletions = function(editor, session, pos, prefix, callback) {
            ...
            fetch("http://62.234.94.93:8080/recommendation?type="+types[i] + "&info=" + info[i],{
    ...
    var nliCompleter = {
        ...
        insertMatch : function (editor,data) {
            ...
            fetch("http://62.234.94.93:8080/parse?row=" + editor.selection.getCursor().row + "&column=" + editor.selection.getCursor().column,{
